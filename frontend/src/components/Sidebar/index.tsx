            ...
            <TooltipTrigger asChild>
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-150 ${
                  isHomePage ? 'bg-gray-100 dark:bg-gray-800' : 'hover:bg-gray-100 dark:hover:bg-gray-800'
                }`}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-150 ${
                  isMeetingPage ? 'bg-gray-100 dark:bg-gray-800' : 'hover:bg-gray-100 dark:hover:bg-gray-800'
                }`}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-150 ${
                  isSettingsPage ? 'bg-gray-100 dark:bg-gray-800' : 'hover:bg-gray-100 dark:hover:bg-gray-800'
                }`}
              >
          ...
          className={`flex items-center transition-all duration-150 group ${
            item.type === 'folder' && depth === 0
              ...
              : `px-3 py-2 my-0.5 rounded-md text-sm ${
                  isActive ? 'bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 font-medium' :
                  hasTranscriptMatch ? 'bg-yellow-50 dark:bg-yellow-900/20' : 'hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300'
                } cursor-pointer`
          }`}
          ...
          {item.type === 'folder' ? (
            ...
            <div className="flex flex-col w-full">
              <div className="flex items-center w-full">
                {isMeetingItem ? (
                  <div className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full mr-2 bg-gray-100 dark:bg-gray-700">
                    <File className="w-3.5 h-3.5 text-gray-600 dark:text-gray-400" />
                  </div>
                ) : (
                ...
                {isMeetingItem && (
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                    <button
                      ...
                      className="hover:text-blue-600 dark:hover:text-blue-400 p-1 rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/30 flex-shrink-0"
                    ...
                    <button
                      ...
                      className="hover:text-red-600 dark:hover:text-red-400 p-1 rounded-md hover:bg-red-50 dark:hover:bg-red-900/30 flex-shrink-0"
              ...
              {hasTranscriptMatch && (
                <div className="mt-1 ml-8 text-xs text-gray-500 dark:text-gray-400 bg-yellow-50 dark:bg-yellow-900/20 p-1.5 rounded border border-yellow-100 dark:border-yellow-800 line-clamp-2">
  ...
  return (
    <div className="fixed top-0 left-0 h-screen z-40">
      ...
      <button
        ...
        className="absolute -right-6 top-20 z-50 p-1 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full shadow-lg border dark:border-gray-600"
          ...
          <div className="flex-1">
            {!isCollapsed && (
              ...
              <input
                ...
                className="block w-full pl-8 pr-3 py-1.5 border border-gray-200 dark:border-gray-600 rounded-md text-xs placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
              />
              {searchQuery && (
                <button
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex-shrink-0">
            {!isCollapsed && (
              <div 
                onClick={() => router.push('/')}
                className="p-3 text-lg font-semibold items-center hover:bg-gray-100 dark:hover:bg-gray-800 h-10 flex mx-3 mt-3 rounded-lg cursor-pointer text-gray-900 dark:text-gray-100"
              >
        ...
        {!isCollapsed && (
          ...
          <div className="flex-shrink-0 p-2 border-t border-gray-100 dark:border-gray-700">
            <button
              ...
              <button
                onClick={() => router.push('/settings')}
                className="w-full flex items-center justify-center px-3 py-1.5 mt-1 mb-1 text-sm font-medium text-gray-700 dark:text-gray-200 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-lg transition-colors shadow-sm"
              >
